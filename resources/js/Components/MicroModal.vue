...
// async これをつけると関数が非同期になる。awaitを使うときには必要。
// await APIからデータが返ってくるまで待つ
...
<template>
  ...
  <button  @click="searchCustomers" type="button" class="flex mx-auto text-white bg-teal-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" >検索する</button>
</template>
